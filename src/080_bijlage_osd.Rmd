...
## De vraagstelling beantwoordt een maatschappelijk relevante informatiebehoefte
...
-   Standaard rol van BMK:
    ...
    -   Aanreiken van een mogelijke methodologie (cfr.
        > [[leidraad]{.ul}](https://pureportal.inbo.be/portal/nl/publications/ontwerp-en-evaluatie-van-meetnetten-voor-het-milieu-en-natuurbeleid(11aa46ea-da22-4a3a-a376-08715cba92df).html)
...
-   Standaard rol van onderzoeksteam:
    ...
    -   Desgewenst een schaduwmeetnet uitwerken om een beter idee te krijgen van
        ...
        > 2010]{.ul}](https://pureportal.inbo.be/portal/nl/publications/schaduwmeetnet-bosinventarisatie(c9b2e18f-82ca-4b08-8b88-7ee306f3a994).html))
...
-   Standaard rol van onderzoeksteam:
    ...
    -   De [[FAIR]{.ul}](https://www.go-fair.org/fair-principles/) principes
...
-   Standaard rol van Databeheer, OSCIBIO en Bibliotheek en Informatiebeheer :
    ...
    -   Aanbieden en ondersteunen van het gebruik van het
        > [[DMPOnline.be]{.ul}](https://dmponline.be/) platform voor het
...
## Automatische datainzameling wordt ingezet
...
## Validatieprocedures tijdens gegevensinzameling worden toegepast
...
## De data zijn op een degelijke manier opgeslagen
...
## De voorbewerking van data gebeurt reproduceerbaar
...
-   Standaard rol van onderzoeksteam:
    ...
    -   Organiseren van validatie (peer review) van de analyse (bvb. door te
        ...
        > rechtstreeks betrokken is bij de analyse gevraagd wordt om de code na
        > te kijken)
...
## Versies van de gebruikte data en van de analyse worden bijgehouden
...
-   Standaard rol van BMK, OSCIBIO en Databeheer:
    ...
    -   Voorzien van opleiding en ondersteuning voor het reproduceren van de
        ...
        > mee opgenomen zijn bij het versiebeheer van de code (bv. Zenodo,
        > databanken).

# Publicatie & delen

## De resultaten worden in de gepaste context geïnterpreteerd
...
-   Standaard rol van onderzoeksteam:
    ...
    -   Het onderzoeksteam maakt een afweging i.v.m. het publiceren van de data,
        ...
        > [[Opendatabeleid]{.ul}](https://www.inbo.be/nl/opendatabeleid) het
        > publiceren als Open Data het standaard uitgangspunt is. Deze afweging
        > wordt publiek gemaakt. Tulloch et al (2018)
        > [[https://doi.org/10.1038/s41559-018-0608-1]{.ul}](https://doi.org/10.1038/s41559-018-0608-1)
...
-   Standaard rol van OSCIBIO:
    ...
    -   Technisch advies over keuze van dataformaat, documentatie en platform
        > voor publiek beschikbaar stellen van data. Voor data-publicatie naar
        > GBIF biedt dit team ook ondersteuning.
...
richtlijnen]{.ul}](https://www.go-fair.org/fair-principles/) die ook toegepast
...
-   Standaard rol van onderzoeksteam:
    ...
    -   De finale versies van de scripts en documentatie worden in principe
        ...
        > https://choosealicense.com/]{.ul}](https://opensource.org/licenses)).
...
beleid]{.ul}](https://www.inbo.be/nl/openaccess-beleid) publiek beschikbaar
gesteld.

-   Standaard rol van onderzoeksteam:

    -   Ter beschikking stellen van publicaties aan team Bibliotheek en
        > Informatiebeer of zelf invoeren in CRIS-systeem
...
## Er wordt in de publicaties naar de verschillende outputs gerefereerd (via een digital object identifier of kortweg DOI)

DOI, of de Digital Object Identifier, is een systeem voor het identificeren van
content in een digitale omgeving. Digitale documenten of objecten kunnen in de
loop van de tijd veranderen van inhoud of van plaats. Omdat de DOI-naam
ongewijzigd blijft kan een object blijvend geïdentificeerd worden.

-   Standaard rol van onderzoeksteam:

    -   Waar relevant de referenties (met DOI) van verschillende gerelateerde
        > outputs zoals dataset, data paper, gepubliceerd protocol, broncode (op
        > Zenodo) opnemen
...
-   Standaard rol van Bibliotheek & Informatiebeheer + BMK
    ...
    -   Onderhoud van de INBO-citatiestijlbestanden (o.a. het
        > [[gedeponeerde]{.ul}](https://github.com/citation-style-language/styles/blob/master/research-institute-for-nature-and-forest.csl)
        > stijlbestand research-institute-for-nature-and-forest.csl)

## Er wordt over de outputs en daarbij gebruikte (Open Science) methodieken gecommuniceerd
...
betrouwbare en doorzoekbare archivering van de data, stalen, protocollen en code
toegepast (Zenodo, Open Science Framework (OSF), PURE, etc.), conform het nog
verder uit te werken INBO-beleid rond archivering (van zowel analoog als
digitaal materiaal).
...
## Code wordt gearchiveerd

-   Standaard rol van onderzoeksteam:

    -   Toepassen van richtlijnen rond archivering van code
...
Er wordt een inspanning geleverd om gebruikte systemen, data, code en
...
-   Standaard rol van onderzoeksteam:
    ...
    -   Onderzoeken welke data / code reeds beschikbaar is vooraleer zelf nieuwe
        > dingen in te zamelen of te ontwikkelen.
