...
efficiëntie van het onderzoek en leidt tot meer mogelijkheden voor samenwerking.
...
[@wouters_ontwerp_2008]*, *onderzoeksprotocols, statistische inferentie* en
...
Reproduceerbaarheid van de onderzoeksresultaten is noodzakelijk om de kwaliteit
...
instellingen zullen hierbij worden ondersteund door *data stewards.* Bij de zes
VWI's zijn momenteel drie data stewards actief, waarvan één werkzaam bij het
INBO. Om de vooruitgang van Open Science in de verschillende betrokken
instellingen op te volgen werden vijf Key Performance Indicators (KPI's)
...
programma's voor te stellen voor de meerjarenplanning van het INBO (2020-2024).
...
-   We werken **gestructureerd** en **transparant**:
    ...
    -   De verschillende doelen zijn elk toegewezen aan een specifiek onderdeel
        ...
        -   Noot: de huidige OSD's dekken momenteel niet alle aspecten van
            postpositivistisch en constructivistisch onderzoek af. Naar de
...
-   *Vlaamse Commissie voor Wetenschappelijke Integriteit (VCWI) & Commissie
    Wetenschappelijke Integriteit INBO (CWI-INBO)*: Open Science draagt in
